...
var BasedPlugin = class extends import_obsidian.Plugin {
 ...
 ${noteData.text_content}`;
  ...
  async syncVault(mdContent) {
    ...
    try {
      if (mdContent) {
        await axios_default.post(this.settings.serverUrl, mdContent, {
          headers: {
      ...
      if ((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.data) {
        await Promise.all(
          Object.entries(response.data.data).map(
            ([noteKey, noteData]) => this.createOrUpdateNote(
              noteKey,
              noteData
            )
          )
